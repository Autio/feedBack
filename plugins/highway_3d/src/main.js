...
import { createHudOverlays } from './hud-overlays.js';
import {
    BG_DEFAULTS,
    BG_STYLES,
    BG_ZERO_BANDS,
...
function createFactory() {
    ...
    // 2D HUD overlays (chord diagram, section/tone HUDs, lyrics).
    const _hudOverlays = createHudOverlays();
    const {
        _drawDiagramCached,
        drawLyrics,
        drawSectionHud,
    ...
    function applySize(w, h) {
        ...
        _hudOverlays.clearDiagramCache();
        cam.aspect = w / h;
        cam.updateProjectionMatrix();
    ...
    function teardown() {
        ...
        _diagEntranceT = 1.0; _diagLastKey = null; _hudOverlays.clearDiagramCache();
    ...
    return {
        ...
        destroy() {
            _destroyed = true; _isReady = false; _diagChord = null; _diagPrev = null; _diagLastKey = null; _hudOverlays.clearDiagramCache();
